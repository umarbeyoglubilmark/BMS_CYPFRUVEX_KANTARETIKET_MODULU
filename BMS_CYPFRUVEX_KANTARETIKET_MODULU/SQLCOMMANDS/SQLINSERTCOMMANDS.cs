...
namespace BMS_CYPFRUVEX_KANTARETIKET_MODULU.SQLCOMMANDS
{
    public class SQLINSERTCOMMANDS
    {
        ...
        public SqlCommand BMS_KE_KANTAR_INSERT(BMS_KE_KANTAR B, bool INSERTTOBM, bool INSERTLOGICALREF)
        {
            try
            {
                ...
                SqlCommand com = new SqlCommand("INSERT INTO " + tableName + "(" + (INSERTLOGICALREF ? "LOGICALREF, " : "") + "TARIH, PLAKAID, KONTRAKTORID, URETICIID, URUNID, MIKTAR, BIRIM, KULLANICI, BARKODYAZIMMIKTAR, ACIKLAMA, LOGOAKTARIMI, LOGOAKTARIMTARIHI, LOGOFISID, ERRORMESSAGE, TSTATUS,TARTI_BELGE_NO,SOZLESME_NO,AMBARID_GIDECEGIYER,OZELKOD_BOLGE,YETKIKOD_BOLGEDETAY,ODEMEPLANID_SOZLESMETURU,SALEMANID_SO ,AMBARID_GIDECEGIYERKOD,OZELKOD_BOLGEKOD,YETKIKOD_BOLGEDETAYKOD,ODEMEPLANID_SOZLESMETURUKOD,SALEMANID_SOKOD,BINLIKSAYISI,FIRE_MIKTAR,KENDI_PLAKASI_MI) VALUES (" + (INSERTLOGICALREF ? "@LOGICALREF, " : "") + "@TARIH, @PLAKAID, @KONTRAKTORID, @URETICIID, @URUNID, @MIKTAR, @BIRIM, @KULLANICI, @BARKODYAZIMMIKTAR, @ACIKLAMA, @LOGOAKTARIMI, @LOGOAKTARIMTARIHI, @LOGOFISID, @ERRORMESSAGE, @TSTATUS,@TARTI_BELGE_NO,@SOZLESME_NO,@AMBARID_GIDECEGIYER,@OZELKOD_BOLGE,@YETKIKOD_BOLGEDETAY,@ODEMEPLANID_SOZLESMETURU,@SALEMANID_SO,@AMBARID_GIDECEGIYERKOD,@OZELKOD_BOLGEKOD,@YETKIKOD_BOLGEDETAYKOD,@ODEMEPLANID_SOZLESMETURUKOD,@SALEMANID_SOKOD,@BINLIKSAYISI,@FIRE_MIKTAR,@KENDI_PLAKASI_MI) SELECT " +
                ...
                catch { com.Parameters.AddWithValue("@LOGICALREF", DBNull.Value); }
                ...
                try { com.Parameters.AddWithValue("@AMBARID_GIDECEGIYERKOD", B.AMBARID_GIDECEGIYERKOD); } catch { com.Parameters.AddWithValue("@AMBARID_GIDECEGIYERKOD", DBNull.Value); }
                try { com.Parameters.AddWithValue("@OZELKOD_BOLGEKOD", B.OZELKOD_BOLGEKOD); } catch { com.Parameters.AddWithValue("@OZELKOD_BOLGEKOD", DBNull.Value); }
                try { com.Parameters.AddWithValue("@YETKIKOD_BOLGEDETAYKOD", B.YETKIKOD_BOLGEDETAYKOD); } catch { com.Parameters.AddWithValue("@YETKIKOD_BOLGEDETAYKOD", DBNull.Value); }
                try { com.Parameters.AddWithValue("@ODEMEPLANID_SOZLESMETURUKOD", B.ODEMEPLANID_SOZLESMETURUKOD); } catch { com.Parameters.AddWithValue("@ODEMEPLANID_SOZLESMETURUKOD", DBNull.Value); }
                try { com.Parameters.AddWithValue("@SALEMANID_SOKOD", B.SALEMANID_SOKOD); } catch { com.Parameters.AddWithValue("@SALEMANID_SOKOD", DBNull.Value); }
                try { com.Parameters.AddWithValue("@BINLIKSAYISI", B.BINLIKSAYISI); } catch { com.Parameters.AddWithValue("@BINLIKSAYISI", DBNull.Value); }
                try { com.Parameters.AddWithValue("@FIRE_MIKTAR", B.FIRE_MIKTAR); } catch { com.Parameters.AddWithValue("@FIRE_MIKTAR", DBNull.Value); }
                try { com.Parameters.AddWithValue("@KENDI_PLAKASI_MI", B.KENDI_PLAKASI_MI ? 1 : 0); } catch { com.Parameters.AddWithValue("@KENDI_PLAKASI_MI", 0); }
                return com;
            }
            catch
            {
        ...
        public SqlCommand BMS_KE_KANTAR_UPDATE(BMS_KE_KANTAR B, bool INSERTTOBM, bool INSERTLOGICALREF)
        {
            try
            {
                string tableName = "BMS_KE_KANTAR";
                ...
                SqlCommand com = new SqlCommand("UPDATE " + tableName + " SET TARIH=@TARIH, PLAKAID=@PLAKAID, KONTRAKTORID=@KONTRAKTORID, URETICIID=@URETICIID, URUNID=@URUNID, MIKTAR=@MIKTAR, BIRIM=@BIRIM, KULLANICI=@KULLANICI, BARKODYAZIMMIKTAR=@BARKODYAZIMMIKTAR, ACIKLAMA=@ACIKLAMA, LOGOAKTARIMI=@LOGOAKTARIMI, LOGOAKTARIMTARIHI=@LOGOAKTARIMTARIHI, LOGOFISID=@LOGOFISID, ERRORMESSAGE=@ERRORMESSAGE, TSTATUS=@TSTATUS,TARTI_BELGE_NO=@TARTI_BELGE_NO,SOZLESME_NO=@SOZLESME_NO,AMBARID_GIDECEGIYER=@AMBARID_GIDECEGIYER,OZELKOD_BOLGE=@OZELKOD_BOLGE,YETKIKOD_BOLGEDETAY=@YETKIKOD_BOLGEDETAY,ODEMEPLANID_SOZLESMETURU=@ODEMEPLANID_SOZLESMETURU,SALEMANID_SO=@SALEMANID_SO ,AMBARID_GIDECEGIYERKOD=@AMBARID_GIDECEGIYERKOD,OZELKOD_BOLGEKOD=@OZELKOD_BOLGEKOD,YETKIKOD_BOLGEDETAYKOD=@YETKIKOD_BOLGEDETAYKOD,ODEMEPLANID_SOZLESMETURUKOD=@ODEMEPLANID_SOZLESMETURUKOD,SALEMANID_SOKOD=@SALEMANID_SOKOD,KENDI_PLAKASI_MI=@KENDI_PLAKASI_MI WHERE LOGICALREF= " + B.LOGICALREF);
                if (B.TARIH != new DateTime())
                    com.Parameters.AddWithValue("@TARIH", B.TARIH);
                else
                    com.Parameters.AddWithValue("@TARIH", DBNull.Value);
        ...
        public SqlCommand BM_XXX_XX_CLFLINE_INSERT(BM_XXX_XX_CLFLINE B, bool INSERTTOBM, bool INSERTLOGICALREF, string FIRMNR, string PERIODNR)
        {
            try
            {
        ...
        public SqlCommand BM_XXX_XX_INVOICE_INSERT(BM_XXX_XX_INVOICE B, bool INSERTTOBM, bool INSERTLOGICALREF, string FIRMNR, string PERIODNR)
        {
            try
            {
        ...
        public SqlCommand BM_XXX_XX_STFICHE_INSERT(BM_XXX_XX_STFICHE B, bool INSERTTOBM, bool INSERTLOGICALREF, string FIRMNR, string PERIODNR)
        {
            try
            {
                ...
                if (!INSERTTOBM)
                    tableName = tableName.Replace("BM", "LG").Replace("BH", "LH").Replace("L_", "B_").Replace("XXX", FIRMNR)
                 .Replace("XX", PERIODNR);
                SqlCommand com = new SqlCommand("INSERT INTO " + tableName + "(" + (INSERTLOGICALREF ? "LOGICALREF, " : "") + "GRPCODE, TRCODE, IOCODE, FICHENO, DATE_, FTIME, DOCODE, INVNO, SPECODE, CYPHCODE, INVOICEREF, CLIENTREF, RECVREF, ACCOUNTREF, CENTERREF, PRODORDERREF, PORDERFICHENO, SOURCETYPE, SOURCEINDEX, SOURCEWSREF, SOURCEPOLNREF, SOURCECOSTGRP, DESTTYPE, DESTINDEX, DESTWSREF, DESTPOLNREF, DESTCOSTGRP, FACTORYNR, BRANCH, DEPARTMENT, COMPBRANCH, COMPDEPARTMENT, COMPFACTORY, PRODSTAT, DEVIR, CANCELLED, BILLED, ACCOUNTED, UPDCURR, INUSE, INVKIND, ADDDISCOUNTS, TOTALDISCOUNTS, TOTALDISCOUNTED, ADDEXPENSES, TOTALEXPENSES, TOTALDEPOZITO, TOTALPROMOTIONS, TOTALVAT, GROSSTOTAL, NETTOTAL, GENEXP1, GENEXP2, GENEXP3, GENEXP4, GENEXP5, GENEXP6, REPORTRATE, REPORTNET, EXTENREF, PAYDEFREF, PRINTCNT, FICHECNT, ACCFICHEREF, CAPIBLOCK_CREATEDBY, CAPIBLOCK_CREADEDDATE, CAPIBLOCK_CREATEDHOUR, CAPIBLOCK_CREATEDMIN, CAPIBLOCK_CREATEDSEC, CAPIBLOCK_MODIFIEDBY, CAPIBLOCK_MODIFIEDDATE, CAPIBLOCK_MODIFIEDHOUR, CAPIBLOCK_MODIFIEDMIN, CAPIBLOCK_MODIFIEDSEC, SALESMANREF, CANCELLEDACC, SHPTYPCOD, SHPAGNCOD, TRACKNR, GENEXCTYP, LINEEXCTYP, TRADINGGRP, TEXTINC, SITEID, RECSTATUS, ORGLOGICREF, WFSTATUS, SHIPINFOREF, DISTORDERREF, SENDCNT, DLVCLIENT, DOCTRACKINGNR, ADDTAXCALC, TOTALADDTAX, UGIRTRACKINGNO, QPRODFCREF, VAACCREF, VACENTERREF, ORGLOGOID, FROMEXIM, FRGTYPCOD, TRCURR, TRRATE, TRNET, EXIMWHFCREF, EXIMFCTYPE, MAINSTFCREF, FROMORDWITHPAY, PROJECTREF, WFLOWCRDREF, STATUS, UPDTRCURR, TOTALEXADDTAX, AFFECTCOLLATRL, DEDUCTIONPART1, DEDUCTIONPART2, GRPFIRMTRANS, AFFECTRISK, DISPSTATUS, APPROVE, APPROVEDATE, CANTCREDEDUCT, SHIPDATE, SHIPTIME, ENTRUSTDEVIR, RELTRANSFCREF, FROMTRANSFER, GUID, GLOBALID, COMPSTFCREF, COMPINVREF, TOTALSERVICES, CAMPAIGNCODE, OFFERREF, EINVOICETYP, EINVOICE, NOCALCULATE, PRODORDERTYP, QPRODFCTYP, PRINTDATE, PRDORDSLPLNRESERVE, CONTROLINFO, EDESPATCH, DOCDATE, DOCTIME, EDESPSTATUS, PROFILEID, DELIVERYCODE, DESTSTATUS, CANCELEXP, UNDOEXP, CANCELDATE, CREATEWHERE, PUBLICBNACCREF, ACCEPTEINVPUBLIC, VATEXCEPTCODE, VATEXCEPTREASON, ATAXEXCEPTCODE, ATAXEXCEPTREASON, TAXFREECHX ) VALUES (" + (INSERTLOGICALREF ? "@LOGICALREF, " : "") + "@GRPCODE, @TRCODE, @IOCODE, @FICHENO, @DATE_, @FTIME, @DOCODE, @INVNO, @SPECODE, @CYPHCODE, @INVOICEREF, @CLIENTREF, @RECVREF, @ACCOUNTREF, @CENTERREF, @PRODORDERREF, @PORDERFICHENO, @SOURCETYPE, @SOURCEINDEX, @SOURCEWSREF, @SOURCEPOLNREF, @SOURCECOSTGRP, @DESTTYPE, @DESTINDEX, @DESTWSREF, @DESTPOLNREF, @DESTCOSTGRP, @FACTORYNR, @BRANCH, @DEPARTMENT, @COMPBRANCH, @COMPDEPARTMENT, @COMPFACTORY, @PRODSTAT, @DEVIR, @CANCELLED, @BILLED, @ACCOUNTED, @UPDCURR, @INUSE, @INVKIND, @ADDDISCOUNTS, @TOTALDISCOUNTS, @TOTALDISCOUNTED, @ADDEXPENSES, @TOTALEXPENSES, @TOTALDEPOZITO, @TOTALPROMOTIONS, @TOTALVAT, @GROSSTOTAL, @NETTOTAL, @GENEXP1, @GENEXP2, @GENEXP3, @GENEXP4, @GENEXP5, @GENEXP6, @REPORTRATE, @REPORTNET, @EXTENREF, @PAYDEFREF, @PRINTCNT, @FICHECNT, @ACCFICHEREF, @CAPIBLOCK_CREATEDBY, @CAPIBLOCK_CREADEDDATE, @CAPIBLOCK_CREATEDHOUR, @CAPIBLOCK_CREATEDMIN, @CAPIBLOCK_CREATEDSEC, @CAPIBLOCK_MODIFIEDBY, @CAPIBLOCK_MODIFIEDDATE, @CAPIBLOCK_MODIFIEDHOUR, @CAPIBLOCK_MODIFIEDMIN, @CAPIBLOCK_MODIFIEDSEC, @SALESMANREF, @CANCELLEDACC, @SHPTYPCOD, @SHPAGNCOD, @TRACKNR, @GENEXCTYP, @LINEEXCTYP, @TRADINGGRP, @TEXTINC, @SITEID, @RECSTATUS, @ORGLOGICREF, @WFSTATUS, @SHIPINFOREF, @DISTORDERREF, @SENDCNT, @DLVCLIENT, @DOCTRACKINGNR, @ADDTAXCALC, @TOTALADDTAX, @UGIRTRACKINGNO, @QPRODFCREF, @VAACCREF, @VACENTERREF, @ORGLOGOID, @FROMEXIM, @FRGTYPCOD, @TRCURR, @TRRATE, @TRNET, @EXIMWHFCREF, @EXIMFCTYPE, @MAINSTFCREF, @FROMORDWITHPAY, @PROJECTREF, @WFLOWCRDREF, @STATUS, @UPDTRCURR, @TOTALEXADDTAX, @AFFECTCOLLATRL, @DEDUCTIONPART1, @DEDUCTIONPART2, @GRPFIRMTRANS, @AFFECTRISK, @DISPSTATUS, @APPROVE, @APPROVEDATE, @CANTCREDEDUCT, @SHIPDATE, @SHIPTIME, @ENTRUSTDEVIR, @RELTRANSFCREF, @FROMTRANSFER, @GUID, @GLOBALID, @COMPSTFCREF, @COMPINVREF, @TOTALSERVICES, @CAMPAIGNCODE, @OFFERREF, @EINVOICETYP, @EINVOICE, @NOCALCULATE, @PRODORDERTYP, @QPRODFCTYP, @PRINTDATE, @PRDORDSLPLNRESERVE, @CONTROLINFO, @EDESPATCH, @DOCDATE, @DOCTIME, @EDESPSTATUS, @PROFILEID, @DELIVERYCODE, @DESTSTATUS, @CANCELEXP, @UNDOEXP, @CANCELDATE, @CREATEWHERE, @PUBLICBNACCREF, @ACCEPTEINVPUBLIC, @VATEXCEPTCODE, @VATEXCEPTREASON, @ATAXEXCEPTCODE, @ATAXEXCEPTREASON, @TAXFREECHX ) SELECT " +
                 (INSERTLOGICALREF ? "MAX(LOGICALREF) FROM " + tableName + "" : " SCOPE_IDENTITY() "));
                try
                {
                    if (INSERTLOGICALREF)
        ...
        public SqlCommand BM_XXX_XX_STLINE_INSERT(BM_XXX_XX_STLINE B, bool INSERTTOBM, bool INSERTLOGICALREF, string FIRMNR, string PERIODNR)
        {
            try
            {
        ...
        public SqlCommand BM_XXX_XX_PAYTRANS_INSERT(BM_XXX_XX_PAYTRANS B, bool INSERTTOBM, bool INSERTLOGICALREF, string FIRMNR, string PERIODNR)
        {
            try
            {
