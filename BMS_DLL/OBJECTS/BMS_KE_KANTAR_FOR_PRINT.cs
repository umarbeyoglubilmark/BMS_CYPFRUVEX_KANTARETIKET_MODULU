...
{
    public class BMS_KE_KANTAR_FOR_PRINT
    {
        ...
        public string  URETICI { get; set; } = string.Empty; 
        public string  KONTRAKTOR { get; set; } = string.Empty; 
        public string  GIDECEGI_YER { get; set; } = string.Empty; 
        public string  BOLGE { get; set; } = string.Empty; 
        public string  BOLGE_DETAY { get; set; } = string.Empty; 
        public string  SOZLESME_TURU { get; set; } = string.Empty; 
